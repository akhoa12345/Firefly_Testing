...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Create new withdrawal  Transactions  F_057ce1/li_The transaction amount field is required'), 
    0)
