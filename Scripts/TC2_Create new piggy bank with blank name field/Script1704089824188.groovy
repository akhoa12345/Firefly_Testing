...
WebUI.click(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/div_Mandatory fields                       _afd734'))

WebUI.click(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/button_Store new piggy bank'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/p_The name field is required'), 
    0)
