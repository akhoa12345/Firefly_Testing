...
WebUI.setText(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/textarea_notes'), 'Buying a new iphone')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/p_The targetdate is not a valid date'), 
    0)
