...
WebUI.click(findTestObject('Object Repository/Page_Whats playing  Firefly III/span_Piggy banks'))

WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/a_Create new piggy bank'))

WebUI.setText(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/input_name'), 'Iphone 13')
...
WebUI.setText(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/input_targetamount'), '500000000000000000000000000')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/p_The target amount may not be greater than_578370'), 
    0)
